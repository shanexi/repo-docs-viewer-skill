...
The agent will copy the zero-build viewer into `tools/docs-viewer/`, validate the routes, start the local server, and open the preview in Codex Desktop, Claude Code Desktop, or another available browser surface.
